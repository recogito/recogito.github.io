...
![Use this template button](/src/assets/use-this-template-button.png)
...
![Create repository owner selection](/src/assets/create-repository-owner.png)
...
2. Add plugin to test application dependencies in `.dev/package.json`:
```jsonc
{
  "dependencies": {
    "@performant/plugin-hello-world": "file:../"
...
3. Configure Astro integration in `.dev/astro.config.mjs`:
```js
import HelloWorldPlugin from "@performant/plugin-hello-world";
...
![Styled accordion example](/src/assets/styling-accordion.png)
